...
- **Doações:** a tela Donate localizada tornou explícito que o apoio é opcional,
  mantém o jogo independente/offline e não concede vantagem, nave ou progresso.
  Os links externos de Ko-Fi e Buy Me a Coffee usam `noopener noreferrer`.
...
visível sem atrapalhar o gameplay. — **entregue:** três temas selecionáveis,
quatro rastros, quatro efeitos de explosão e títulos locais são desbloqueáveis
por gameplay; a Donate é clara, opcional e não cria entitlement pago.
